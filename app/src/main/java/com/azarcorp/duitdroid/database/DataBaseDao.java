...
public interface DataBaseDao {
    ...
    @Query("UPDATE tbl_keuangan SET keterangan = :keterangan, tanggal = :tgl, jml_uang = :harga, foto_uri = :fotoUri WHERE uid = :uid AND tipe = 'pengeluaran'")
    void updateDataPengeluaran(String keterangan, String tgl, int harga, String fotoUri, int uid);
    ...
    @Query("UPDATE tbl_keuangan SET keterangan = :keterangan, tanggal = :tgl, jml_uang = :harga, foto_uri = :fotoUri WHERE uid = :uid AND tipe = 'pemasukan'")
    void updateDataPemasukan(String keterangan, String tgl, int harga, String fotoUri, int uid);
}
